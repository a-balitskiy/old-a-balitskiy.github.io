...
[Download for Windows]({{site.baseurl}}/files/Zonotile_VR.zip). It should run on any major VR headset on top of SteamVR. Email me if there are issues with controls or anything!
